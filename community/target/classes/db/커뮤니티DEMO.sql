...
VALUES(SEQ_BOA_NUM.NEXTVAL, 'dbrtlarb', 1001, 'SMF', '공지사항', 1, '테스트', '테스트', SYSDATE, SYSDATE);
commit;


SELECT BOA_NUM, M.MEM_NAME, CAT_C, CAT_NAME, CAT_NAME_C, CAT_P, BOA_TITLE, BOA_CONTENT, BOA_DATE_REG, BOA_DATE_UP, EVE_NAME, BOA_HIT, BOA_REP_NUM, REP_UP, REP_DOWN
