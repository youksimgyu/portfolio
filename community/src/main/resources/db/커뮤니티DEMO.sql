...
CREATE TABLE BOARD(
    ...
    REP_UP                  NUMBER,
    REP_DOWN                NUMBER,
    FOREIGN KEY(CAT_C)      REFERENCES CATEGORY(CAT_C),
...
INSERT INTO AD_BOARD
        (SELECT AD_BOA_C, AD_BOA_P, AD_BOA_TITLE, AD_BOA_CONTENT, AD_BOA_DATE_REG, AD_BOA_DATE_UP FROM AD_BOARD)
VALUES (AD_BOA_C, AD_BOA_P, AD_BOA_TITLE, AD_BOA_CONTENT, AD_BOA_DATE_REG, AD_BOA_DATE_UP);
