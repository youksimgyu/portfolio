...
<!-- Main -->
<form id="modifyForm" method="post" action="boardModify" class="contatiner p-5 my-5 border" enctype="multipart/form-data">
   ...
   <div class="content-body">
	...
	<div class="form-group mb-3 mt-3 row">
	    ...
	    <!-- 게시물 넘버를 숨겨서 넘겨줌 -->
	      ...
	      <input type="text" class="form-control" id="ad_boa_title" name="ad_boa_title" value="${boardVO.ad_boa_title }">
	    </div>
	</div>
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <textarea class="form-control" row="3" id="ad_boa_content" name="ad_boa_content">${boardVO.ad_boa_content }</textarea>
	    </div>
	</div>
   ...
   <div class="content-footer">
	...
	<div class="form-group row">
		<div class="col-sm-12 text-center">
			<button type="submit" class="btn btn-primary" id="btnRegister">수정</button>
		</div>
	</div>
   </div>
