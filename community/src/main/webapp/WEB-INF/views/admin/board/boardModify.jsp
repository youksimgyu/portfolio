   ...
   <div class="content-body">
	...
	<div class="form-group mb-3 mt-3 row">
	    ...
	    <!-- 게시물 넘버를 숨겨서 넘겨줌 -->
	      ...
	      <input type="text" class="form-control" id="boa_title" name="boa_title" value="${boardVO.boa_title }">
	    </div>
	</div>
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <textarea class="form-control" row="3" id="boa_content" name="boa_content">${boardVO.boa_content }</textarea>
	    </div>
	</div>
