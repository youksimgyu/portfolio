  ...
  <header class="blog-header lh-1 py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <input type="hidden" name="type" value="TC">
			<input type="text" class="form-control" style="width: 150px" name="keyword" value="${pageMaker.cri.keyword }" id="searchEnter">
	        <a class="link-secondary" href="/" aria-label="Search" id="search">
