...
<script type="text/javascript">
  ...
  function drawChart() {
	    ...
	    var data = google.visualization.arrayToDataTable(${subData});

	    var options = {
	      title: '2차 카테고리 별 주문통계'
	    };
	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box body">
				...
				<div id="piechart2" style="width: 50%; height: 500px; float: left"></div>
